        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
            ...
            <ScrollView style={dynamicStyles.container}>
                ...
                <View style={dynamicStyles.contentArea}>
                    ...
                    {/* 11. Reviews Section (The logic for this small section remains here, but modals are children) */}
                    <View style={[dynamicStyles.section, dynamicStyles.cardStyle, { backgroundColor: colors.card, ...getWebShadow(DEEP_SOFT_SHADOW) }]}>
                        <View style={dynamicStyles.reviewsHeader}>
                         ...
                         {currentReviews.map(review => (
                            <View key={review.id} style={[dynamicStyles.reviewCard, { backgroundColor: colors.background, ...dynamicStyles.getWebShadow(dynamicStyles.SUBTLE_SHADOW) }]}>
                        ...
                        <TouchableOpacity 
                            onPress={handleWriteReview} // Handler passed down
                    ...
                    <View style={[dynamicStyles.section, dynamicStyles.cardStyle, { backgroundColor: colors.card, ...getWebShadow(DEEP_SOFT_SHADOW) }]}>
                        ...
                        <View style={dynamicStyles.infoPillContainer}>
                             {/* ... InfoPills for System Info (Kept inline as simple structure) */}
