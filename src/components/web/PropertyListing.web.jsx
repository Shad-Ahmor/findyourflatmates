...
const BREAKPOINT = MOBILE_BREAKPOINT; // Ensure BREAKPOINT constant is defined
...
const dummyData = [
  ...
  {
    listingId: '-OfnYnsW2jL3ag4BFu6R', // Ensure dummy data has listingId for testing
    price: '₹ 50,000/mo',
    listingGoal: 'Rent',
...
const PropertyListingCard = ({ item, colors, navigation }) => {
    ...
    // ✅ FIX: Re-introduce robust handler for ID validation and correct navigation call
    const handlePress = () => {
        // Prioritize listingId, fall back to id
        ...
        // 🔥 FIX: Directly navigate to the top-level 'PropertyDetail' screen (App.web.jsx में इसे RootStack में जोड़ा गया है)
        navigation.navigate('PropertyDetail', { 
            propertyId: propertyIdToNavigate // Pass the confirmed ID
        });
    };
    ...
    return (
        <TouchableOpacity 
            ...
            onPress={handlePress} // Use the robust handler
        >
            {/* Property Image */}
            <Image 
